export const wordDatabaseEN = {
  ...
  auditory: [
    ...
    },
    {
      ...
      difficulty: 2,
      question: {
        en: 'Which word rhymes with "contract"?',
        pl: 'Które słowo rymuje się ze słowem "contract" (umowa)?',
        de: 'Welches Wort reimt sich auf "contract" (Vertrag)?',
      },
      options: [
        { text: 'Attract', isCorrect: true, icon: '📢' },
        { text: 'Discount', isCorrect: false, icon: '📢' },
        { text: 'Feedback', isCorrect: false, icon: '📢' },
        { text: 'Schedule', isCorrect: false, icon: '📢' },
      ],
    },
    {
      id: 28,
      ...
      difficulty: 3,
      question: {
        en: 'Which word rhymes with "meeting"?',
        pl: 'Które słowo rymuje się ze słowem "meeting" (spotkanie)?',
        de: 'Welches Wort reimt sich auf "meeting" (Besprechung)?',
      },
      options: [
        { text: 'Greeting', isCorrect: true, icon: '💬' },
        { text: 'Briefing', isCorrect: false, icon: '💬' },
        { text: 'Training', isCorrect: false, icon: '💬' },
        { text: 'Planning', isCorrect: false, icon: '💬' },
      ],
    },
    {
      id: 29,
      ...
      options: [
        ...
        { text: 'Policy', isCorrect: false, icon: '🧠' },
      ],
    },
    {
      id: 30,
      set: 'B',
      type: 'grapheme',
      focus: 'phoneme discrimination — vowel onset',
      difficulty: 3,
      question: {
      ...
      options: [
        { text: 'Analysis', isCorrect: true, icon: '🧠' },
        { text: 'Budget', isCorrect: false, icon: '🧠' },
        { text: 'Contract', isCorrect: false, icon: '🧠' },
    ...
    },
    {
      ...
      type: 'grapheme',
      difficulty: 2,
      focus: 'Homophone — council vs. counsel',
      question: {
        en: 'Which word fits: "The board sought legal ___ before signing the contract"?',
        pl: 'Które słowo pasuje: "Zarząd zasięgnął ___ prawnej przed podpisaniem umowy"?',
        de: 'Welches Wort passt: "Der Vorstand holte rechtlichen ___ ein, bevor der Vertrag unterschrieben wurde"?',
      },
      options: [
        { text: 'Counsel', isCorrect: true, icon: '⚖️' },
        { text: 'Council', isCorrect: false, icon: '⚖️' },
        { text: 'Councel', isCorrect: false, icon: '⚖️' },
        { text: 'Consel', isCorrect: false, icon: '⚖️' },
      ],
    },
    {
      id: 32,
      ...
      type: 'grapheme',
      difficulty: 3,
      focus: 'Homophone — complement vs. compliment',
      question: {
        en: 'Which word fits: "This bonus is meant to ___ your salary, not replace it"?',
        pl: 'Które słowo pasuje: "Ta premia ma ___ Twoje wynagrodzenie, a nie je zastępować"?',
        de: 'Welches Wort passt: "Dieser Bonus soll Ihr Gehalt ___, nicht ersetzen"?',
      },
      options: [
        { text: 'Complement', isCorrect: true, icon: '💰' },
        { text: 'Compliment', isCorrect: false, icon: '💰' },
        { text: 'Complemant', isCorrect: false, icon: '💰' },
        { text: 'Complerment', isCorrect: false, icon: '💰' },
      ],
    },
    {
      id: 33,
      ...
      type: 'grapheme',
      difficulty: 4,
      focus: 'Homophone — waive vs. wave',
      question: {
        en: 'Which word fits: "The client agreed to ___ the late fee"?',
        pl: 'Które słowo pasuje: "Klient zgodził się ___ opłaty za zwłokę"?',
        de: 'Welches Wort passt: "Der Kunde erklärte sich bereit, auf die Verzugsgebühr zu ___"?',
      },
      options: [
        { text: 'Waive', isCorrect: true, icon: '📄' },
        { text: 'Wave', isCorrect: false, icon: '📄' },
        { text: 'Whaive', isCorrect: false, icon: '📄' },
        { text: 'Waeve', isCorrect: false, icon: '📄' },
      ],
    },
  ],
  vocabulary: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: 'Document', isCorrect: false, icon: '⚖️' },
        { text: 'Company', isCorrect: false, icon: '⚖️' },
        { text: 'Agreement', isCorrect: false, icon: '⚖️' },
      ],
    },
    {
      id: 31,
    ...
    },
    {
      ...
      options: [
        ...
        { text: 'Corporate', isCorrect: false, icon: '⚙️' },
        { text: 'Coordinate', isCorrect: false, icon: '⚙️' },
        { text: 'Cooking', isCorrect: false, icon: '⚙️' },
      ],
    },
    {
      id: 43,
    ...
    },
    {
      ...
      options: [
        ...
        { text: 'Rent', isCorrect: false, icon: '✉️' },
        { text: 'Table', isCorrect: false, icon: '✉️' },
        { text: 'Native', isCorrect: false, icon: '✉️' },
      ],
    },
    {
      id: 45,
  ...
  mirrorImage: [
    {
      ...
      options: [
        { text: '➡️', isCorrect: false, label: { en: 'right arrow', pl: 'strzałka w prawo', de: 'Pfeil nach rechts' } },
        { text: '⬅️', isCorrect: true, label: { en: 'left arrow', pl: 'strzałka w lewo', de: 'Pfeil nach links' } },
        { text: '↗️', isCorrect: false, label: { en: 'up-right arrow', pl: 'strzałka w prawo i w górę', de: 'Pfeil nach rechts oben' } },
        { text: '⬆️', isCorrect: false, label: { en: 'up arrow', pl: 'strzałka w górę', de: 'Pfeil nach oben' } },
      ],
    },
    {
      id: 2,
      ...
      options: [
        { text: '⬅️', isCorrect: false, label: { en: 'left arrow', pl: 'strzałka w lewo', de: 'Pfeil nach links' } },
        { text: '➡️', isCorrect: true, label: { en: 'right arrow', pl: 'strzałka w prawo', de: 'Pfeil nach rechts' } },
        { text: '↙️', isCorrect: false, label: { en: 'down-left arrow', pl: 'strzałka w lewo i w dół', de: 'Pfeil nach links unten' } },
        { text: '⬇️', isCorrect: false, label: { en: 'down arrow', pl: 'strzałka w dół', de: 'Pfeil nach unten' } },
      ],
    },
    {
      id: 3,
      ...
      options: [
        { text: '↖️', isCorrect: true, label: { en: 'up-left arrow', pl: 'strzałka w lewo i w górę', de: 'Pfeil nach links oben' } },
        { text: '↙️', isCorrect: false, label: { en: 'down-left arrow', pl: 'strzałka w lewo i w dół', de: 'Pfeil nach links unten' } },
        { text: '↗️', isCorrect: false, label: { en: 'up-right arrow', pl: 'strzałka w prawo i w górę', de: 'Pfeil nach rechts oben' } },
        { text: '↘️', isCorrect: false, label: { en: 'down-right arrow', pl: 'strzałka w prawo i w dół', de: 'Pfeil nach rechts unten' } },
      ],
    },
    {
      id: 4,
      ...
      options: [
        { text: '↗️', isCorrect: true, label: { en: 'up-right arrow', pl: 'strzałka w prawo i w górę', de: 'Pfeil nach rechts oben' } },
        { text: '↙️', isCorrect: false, label: { en: 'down-left arrow', pl: 'strzałka w lewo i w dół', de: 'Pfeil nach links unten' } },
        { text: '↖️', isCorrect: false, label: { en: 'up-left arrow', pl: 'strzałka w lewo i w górę', de: 'Pfeil nach links oben' } },
        { text: '↘️', isCorrect: false, label: { en: 'down-right arrow', pl: 'strzałka w prawo i w dół', de: 'Pfeil nach rechts unten' } },
      ],
    },
    {
      ...
      options: [
        { text: '↘️', isCorrect: false, label: { en: 'down-right arrow', pl: 'strzałka w prawo i w dół', de: 'Pfeil nach rechts unten' } },
        { text: '↖️', isCorrect: false, label: { en: 'up-left arrow', pl: 'strzałka w lewo i w górę', de: 'Pfeil nach links oben' } },
        { text: '↙️', isCorrect: true, label: { en: 'down-left arrow', pl: 'strzałka w lewo i w dół', de: 'Pfeil nach links unten' } },
        { text: '↗️', isCorrect: false, label: { en: 'up-right arrow', pl: 'strzałka w prawo i w górę', de: 'Pfeil nach rechts oben' } },
      ],
    },
    {
      ...
      options: [
        { text: '↙️', isCorrect: false, label: { en: 'down-left arrow', pl: 'strzałka w lewo i w dół', de: 'Pfeil nach links unten' } },
        { text: '↗️', isCorrect: false, label: { en: 'up-right arrow', pl: 'strzałka w prawo i w górę', de: 'Pfeil nach rechts oben' } },
        { text: '↘️', isCorrect: true, label: { en: 'down-right arrow', pl: 'strzałka w prawo i w dół', de: 'Pfeil nach rechts unten' } },
        { text: '↖️', isCorrect: false, label: { en: 'up-left arrow', pl: 'strzałka w lewo i w górę', de: 'Pfeil nach links oben' } },
      ],
    },
    {
      ...
      options: [
        { text: '➡️↗️', isCorrect: false, label: { en: 'right and up-right arrows', pl: 'strzałki w prawo i w prawo-górę', de: 'Pfeile nach rechts und rechts oben' } },
        { text: '↖️⬅️', isCorrect: true, label: { en: 'up-left and left arrows', pl: 'strzałki w lewo-górę i w lewo', de: 'Pfeile nach links oben und links' } },
        { text: '⬅️↙️', isCorrect: false, label: { en: 'left and down-left arrows', pl: 'strzałki w lewo i w lewo-dół', de: 'Pfeile nach links und links unten' } },
        { text: '↘️⬆️', isCorrect: false, label: { en: 'down-right and up arrows', pl: 'strzałki w prawo-dół i w górę', de: 'Pfeile nach rechts unten und oben' } },
      ],
    },
    {
      id: 8,
      ...
      options: [
        { text: '➡️↙️', isCorrect: true, label: { en: 'right and down-left arrows', pl: 'strzałki w prawo i w lewo-dół', de: 'Pfeile nach rechts und links unten' } },
        { text: '↘️⬅️', isCorrect: false, label: { en: 'down-right and left arrows', pl: 'strzałki w prawo-dół i w lewo', de: 'Pfeile nach rechts unten und links' } },
        { text: '↙️➡️', isCorrect: false, label: { en: 'down-left and right arrows', pl: 'strzałki w lewo-dół i w prawo', de: 'Pfeile nach links unten und rechts' } },
        { text: '⬆️↖️', isCorrect: false, label: { en: 'up and up-left arrows', pl: 'strzałki w górę i w lewo-górę', de: 'Pfeile nach oben und links oben' } },
      ],
    },
  ],
  oddOneOut: [
    {
      ...
      options: [
        { text: '🍎', isCorrect: false, label: { en: 'apple', pl: 'jabłko', de: 'Apfel' } },
        { text: '🍊', isCorrect: false, label: { en: 'orange', pl: 'pomarańcza', de: 'Orange' } },
        { text: '🍐', isCorrect: false, label: { en: 'pear', pl: 'gruszka', de: 'Birne' } },
        { text: '🚗', isCorrect: true, label: { en: 'car', pl: 'samochód', de: 'Auto' } },
      ],
    },
    {
      id: 2,
      ...
      options: [
        { text: '🐶', isCorrect: false, label: { en: 'dog', pl: 'pies', de: 'Hund' } },
        { text: '🐱', isCorrect: false, label: { en: 'cat', pl: 'kot', de: 'Katze' } },
        { text: '🐹', isCorrect: false, label: { en: 'hamster', pl: 'chomik', de: 'Hamster' } },
        { text: '🚀', isCorrect: true, label: { en: 'rocket', pl: 'rakieta', de: 'Rakete' } },
      ],
    },
    {
      id: 3,
      ...
      options: [
        { text: '🔺', isCorrect: false, label: { en: 'red triangle', pl: 'czerwony trójkąt', de: 'rotes Dreieck' } },
        { text: '🔷', isCorrect: false, label: { en: 'blue diamond', pl: 'niebieski romb', de: 'blaue Raute' } },
        { text: '🔶', isCorrect: false, label: { en: 'orange diamond', pl: 'pomarańczowy romb', de: 'orange Raute' } },
        { text: '🌳', isCorrect: true, label: { en: 'tree', pl: 'drzewo', de: 'Baum' } },
      ],
    },
    {
      id: 4,
      ...
      options: [
        { text: '⭐', isCorrect: false, label: { en: 'star', pl: 'gwiazda', de: 'Stern' } },
        { text: '🌙', isCorrect: false, label: { en: 'moon', pl: 'księżyc', de: 'Mond' } },
        { text: '☀️', isCorrect: false, label: { en: 'sun', pl: 'słońce', de: 'Sonne' } },
        { text: '🚗', isCorrect: true, label: { en: 'car', pl: 'samochód', de: 'Auto' } },
      ],
    },
    {
      ...
      options: [
        { text: '🚗', isCorrect: false, label: { en: 'car', pl: 'samochód', de: 'Auto' } },
        { text: '🚕', isCorrect: false, label: { en: 'taxi', pl: 'taksówka', de: 'Taxi' } },
        { text: '🚙', isCorrect: false, label: { en: 'SUV', pl: 'terenówka', de: 'Geländewagen' } },
        { text: '✈️', isCorrect: true, label: { en: 'airplane', pl: 'samolot', de: 'Flugzeug' } },
      ],
    },
    {
      id: 6,
      ...
      options: [
        { text: '🐦', isCorrect: false, label: { en: 'bird', pl: 'ptak', de: 'Vogel' } },
        { text: '🦅', isCorrect: false, label: { en: 'eagle', pl: 'orzeł', de: 'Adler' } },
        { text: '🦉', isCorrect: false, label: { en: 'owl', pl: 'sowa', de: 'Eule' } },
        { text: '🐟', isCorrect: true, label: { en: 'fish', pl: 'ryba', de: 'Fisch' } },
      ],
    },
    {
      id: 8,
      ...
      options: [
        ...
        { text: '↘️', isCorrect: false, label: { en: 'down-right arrow', pl: 'strzałka w prawo i w dół', de: 'Pfeil nach rechts unten' } },
        { text: '➡️', isCorrect: false, label: { en: 'right arrow', pl: 'strzałka w prawo', de: 'Pfeil nach rechts' } },
        { text: '⬆️', isCorrect: true, label: { en: 'up arrow', pl: 'strzałka w górę', de: 'Pfeil nach oben' } },
      ],
    },
  ],
  lcwc: [
  ...
  dictation: [
    ...
    },
    {
      ...
      instruction: 'Change the sound and give the new word',
      audioPrompt:
        'Change the vowel sound in the word pin to the short a sound, as in cat. What word do you get?',
      correct: 'pan',
    },
    {
      id: 16,
